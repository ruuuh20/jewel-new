...
export default function Footer({ contact }) {
  return (
    <>
      ...
      {/* SIMPLIFIED FOOTER - Optional cleaner version for homepage */}
  ...
  <div className="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
      ...
      <div className="lg:col-span-1">
        <Link href="/">
          <a className="flex items-center">
            <Image src="/ham-logo.png" width="40" height="40" alt="Educate Together" />
      ...
      <div>
        ...
        <nav className="flex flex-col space-y-2 text-sm text-gray-600">
          <Link href="/about"><a className="hover:text-[#c17854] transition-colors">Who We Are</a></Link>
          <Link href="/leadership"><a className="hover:text-[#c17854] transition-colors">Leadership</a></Link>
          <Link href="/contact"><a className="hover:text-[#c17854] transition-colors">Contact</a></Link>
        </nav>
      </div>
    ...
    <div className="pt-8 mt-8 border-t border-gray-200">
      <div className="flex flex-col items-center justify-between md:flex-row">
        <p className="text-xs text-gray-500">
          © {new Date().getFullYear()} Educate Together. All rights reserved.
        </p>
        <nav className="flex gap-4 mt-4 md:mt-0">
          <Link href="/terms-of-use"><a className="text-xs text-gray-500 hover:text-gray-700">Terms</a></Link>
          <Link href="/privacy"><a className="text-xs text-gray-500 hover:text-gray-700">Privacy</a></Link>
        </nav>
      </div>
    </div>
