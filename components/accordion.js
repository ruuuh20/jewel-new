            ...
            <div className="flex-1 ml-auto md:w-2/3 ">
              <div className="flex flex-wrap items-center -mx-3">
                ...
                <div className="px-3 ml-auto ">
                  <svg className={`w-4 md:w-6 2xl:w-8 transform mt-[6px] md:mt-1 transition ease-in-out duration-300 ${open ? 'rotate-0' : 'rotate-45' }`} viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.305 27.132L26.354 2.084M26.354 27.132L1.306 2.083" stroke="#f5bd1f" strokeWidth="3.24"/></svg>
                </div>
              </div>
            </div>
          </div>
