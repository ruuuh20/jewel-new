                  ...
                  <>
                    ...
                    <section className="md:pt-20">
                      <div className="content">
                        <div className="w-full py-6 mt-6 text-2xl text-center">
                          <h4>Profile / 프로필</h4>
                        </div>
                        <div className="w-full ">
                          <table class="m-auto table-auto">
                            <tbody>
                              <tr>
                                <td className="p-4 pl-8 border-b border-gray-300 dark:border-slate text-slate dark:text-slate-400">
                                  대표
                                </td>
                                <td className="p-4 pr-8 border-b border-gray-300 dark:border-slate text-slate dark:text-slate-400">
                                  함께하는교육
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td className="p-4 pl-8 border-b border-gray-300 dark:border-slate-700 text-slate dark:text-slate-400">
                                  교장
                                </td>
                                <td className="p-4 pr-8 border-b border-gray-300 dark:border-slate-700 text-slate dark:text-slate-400">
                                  가나다라한국문화학교
                                </td>
                              </tr>
                              <tr>
