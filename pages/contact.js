                    ...
                    <>
                      <div className="flex mb-4 text-base md:text-lg">
                        {" "}
                          ...
                          <a href="mailto:kaykim@wearejewel.org" className="transition duration-500 ease-in-out md:text-xl text-secondary-dark hover:text-purple">{post.email} </a>
                      ...
                      <div className="flex mb-4 text-base md:text-lg">
                          ...
                          <span className="transition duration-500 ease-in-out md:text-xl text-secondary-dark hover:text-purple">{post.address} </span>
                      ...
                      <div className="flex mb-4 text-base md:text-lg">
                          ...
                          <a href="tel:2017677500" className="transition duration-500 ease-in-out md:text-xl text-secondary-dark hover:text-purple">{post.phoneNumber}</a>
