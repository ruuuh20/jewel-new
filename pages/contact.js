          ...
          <div className="flex flex-wrap">
            <div className="w-full mt-4 md:p-10 lg:w-5/12">
              <p className="text-base md:text-xl">
                We’d love to hear from you. For all inquiries, you can send an
                email at{" "}
                <a
                  ...
                  posts.map((post) => (
                    <>
                      <div className="flex mb-4 text-base md:text-lg">
                        ...
                        <a
                          href="mailto:kaykim@wearejewel.org"
                          className="transition duration-500 ease-in-out md:text-xl text-secondary-dark hover:text-purple"
                        >
                          {post.email}{" "}
                        </a>
                      </div>
                      <div className="flex mb-4 text-base md:text-lg">
                        ...
                        <span className="transition duration-500 ease-in-out md:text-xl text-secondary-dark hover:text-purple">
                          {post.address}{" "}
                        </span>
                      </div>
                      <div className="flex mb-4 text-base md:text-lg">
