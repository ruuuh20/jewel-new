                      ...
                      <div className="flex flex-wrap items-center">
                        <span className="flex items-center text-sm header-tag md:mr-5">
                          <svg
                            ...
                            width="28"
                            viewBox="0 0 45 45"
                            className="w-3 opacity-50 md:w-4"
                          >
                          ...
                          <span className="block mr-3 text-sm tracking-wide text-gray-700 uppercase">
                            Seminar
                          </span>
                        </span>
                  ...
                  {programData.map((item, i) => {
                    return (
                      <Link href={`/projects/${item.slug.current}`}>
                        <a className="flex flex-wrap border-b py-4 mb-4 bg-[rgba(98,50,0,.04)] shadow hover:shadow-lg hover:bg-yellow-lighter project-box md:mb-4">
