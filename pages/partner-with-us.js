                ...
                <div className="max-w-5xl mx-auto">
                  ...
                  <div className="grid gap-6 mb-16 md:grid-cols-3">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-md border-2 border-gray-100 hover:border-[#e8703a] transition-all duration-300">
                      <div className="w-12 h-12 rounded-full bg-[#e8703a] text-white flex items-center justify-center mb-4">
                    ...
                    <div className="bg-gradient-to-br from-[#f8fafc] to-white p-8 rounded-xl border-2 border-gray-100">
                      ...
                      <ul className="space-y-3 text-gray-700">
                        <li className="flex items-start gap-2">
                          <span className="text-[#e8703a] mt-1">•</span>
                  ...
                  <div className="bg-gradient-to-br from-[#1e3a5f] to-[#2c5282] rounded-2xl p-8 md:p-12 text-white text-center">
                    ...
                    <div className="flex flex-col justify-center gap-4 sm:flex-row">
                      <a
                        ...
                        className="inline-flex items-center justify-center px-8 py-4 font-bold bg-[#e8703a] text-white hover:bg-[#a85232] transition-all duration-300 text-lg shadow-lg hover:shadow-xl rounded-lg"
                      >
